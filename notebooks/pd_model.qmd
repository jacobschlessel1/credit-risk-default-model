...
The XGBoost model had the highest recall for defaulted loans (0.67 
compared to 0.64 and 0.59 for logistic regression and random forest 
respectively), meaning that it captured 67% of true defaults 67%, and 
...
interest rate of the loan, the debt-to-income ratio of the borrower, the 
value of the loan, the term of the loan (60 month loans were more likely 
to default) and the low range of the borrower's FICO score. Of these, 
interest rate was by far the most impactful predictor.
...
To do:
- add explanations of models - feature importance
- model LGD using random forest regressor, xgboost regressor, and pytorch
