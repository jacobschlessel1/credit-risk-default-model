...
This notebook performs initial data inspection for the LendingClub credit 
risk dataset.
...
The following secondary applicant/ joint loan variables all have the same 
number of missing values (2,152,647):
...
Because there is such a small fraction of missing values for these, we will 
assume that missingness is just representative of "did not occur", so 
