...
- `collections_12_mths_ex_med` ??????? COME BACK ???
- `acc_now_delinq` COME BACK
- `chargeoff_within_12_mths` COME BACK
- `delinq_amnt` COME BACK
- `mths_since_recent_bc` COME BACK
- `mths_since_recent_inq` COME BACK
- `pub_rec_bankruptcies` COME BACK
- `tax_liens` COME BACK
